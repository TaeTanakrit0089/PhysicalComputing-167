...
| **3. Keypad (RGB):**     | **ต่อในโปรแกรม tinkercad แล้วส่ง URL ที่ต่อเสร็จใน onlearn**<br><br>จงเขียนโปรแกรมรับค่าจาก Keypad โดยให้แสดงสี ของ Color LED เป็นสีต่างๆ ตามปุ่มที่กด โดยกำหนดสีเองตามใจชอบ                                                                                                                                                                                                                                                  | ![ex03.jpg](files/img/L2.3.png) | 
