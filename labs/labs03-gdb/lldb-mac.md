...
7. **เฝ้าดูตัวแปร:**
   ...
   คำสั่ง `watchpoint set variable` หรือ `wa s v` ใน LLDB เป็นเครื่องมือที่มีประโยชน์ในการตรวจสอบการเปลี่ยนแปลงของค่าในตัวแปรระหว่างการ Debugging
   ...
   การทำงานของคำสั่ง `continue` ด้านบนทำให้เกิดการเปลี่ยนแปลงค่าของตัวแปร `a` ที่โค้ด `a++` (เรียกใช้ค่า `a` ก่อนแล้วค่อยเพิ่มค่า +1)
