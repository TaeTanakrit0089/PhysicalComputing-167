...
เนื่องจาก Apple ได้เปลี่ยนสถาปัตยกรรมของ CPU ใน Mac รุ่นใหม่จาก X86_64 ไปเป็นแบบ ARM ทำให้การใช้งาน GDB บน Mac ARM อาจมีความซับซ้อนกว่ามากๆ
...
6. **Step Through the Code:**
   ...
   - `step`
    ...
    - `finish`
      - สั่งให้โปรแกรมทำงานต่อจนกว่าจะจบฟังก์ชันปัจจุบัน แล้วหยุดที่บรรทัดถัดไปหลังจากที่เรียกใช้ฟังก์ชันนั้น เหมาะสำหรับเมื่อต้องการออกจากฟังก์ชันปัจจุบันอย่างรวดเร็ว
