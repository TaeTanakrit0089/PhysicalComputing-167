...
ลองนึกภาพว่าโค้ดของเราคือเขาวงกตที่ซับซ้อน GDB
เปรียบเสมือนแผนที่และไฟฉายที่ช่วยให้เรามองเห็นเส้นทางการทำงานของโปรแกรมอย่างชัดเจน
...
สามารถติดตั้ง lldb ได้ผ่าน Command Line Tools โดยใช้คำสั่ง `xcode-select --install"`
...
7. **Watch the variable:**
   ...
   จากการทำงานของคำสั่ง `continue` ด้านบนคือเกิดการเปลี่ยบแแปลงของตัวแปร a ที่โค้ด `a++` (เรียกใช้ a ก่อนแล้วค่อยเพิ่มค่า +1)
