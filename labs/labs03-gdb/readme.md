...
2. **Start the Debugger:**
   ...
   gdb main
   ```
   เมื่อเข้ามาในหน้า gdb แล้วจะสังเกตได้ว่าตรงช่องรับคำสั่งจะมีคำว่า `(gdb)` นำหน้าไว้อยู่และจะมีหน้าต่างขึ้นดังรูป
...
บรรทัดและในการรันครั้งที่สองจะแสดงโค้ดมาต่อจากส่วนถูกรันครั้งแรกไปแล้วจนถึงบรรทัดสุดท้าย และถ้าเรียก list อีกรอบจะเกิด
error แบบนี้
![gdb-command-tutorial.jpg](files/run-00-list02.png)
นั่นก็เพราะว่าเราได้เรียกคำสั่ง list
ไปจนถึงคำสั่งสุดท้ายแล้วและเมื่อเรียกอีกมันก็ไม่สามารถเรียกได้เพราะว่าโค้ดได้สิ้นสุดแล้ว วิธีแก้เลยคือต้องเติม Argument
ให้กับคำสั่ง `list`
