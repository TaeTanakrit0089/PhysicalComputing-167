...
7. **Watch the variable:**
   ...
   อีกความเทพเลยก็คือ ปกติถ้าน้องรันคำสั่ง `continue` ไปแล้ว โปรแกรมก็จะทำงานไปเรื่อยๆ จนถุึงจุด Breakpoint
   ...
   จากการทำงานของคำสั่ง `continue` ด้านบนคือเกิดการเปลี่ยบแแปลงของตัวแปร a ที่โค้ด `a++` (เรียกใช้ a
